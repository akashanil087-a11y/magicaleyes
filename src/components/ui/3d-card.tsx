  ...
  (
    ...
    return (
      <motion.div
        ...
        className={cn(
          "relative h-[26rem] w-80 rounded-2xl bg-transparent shadow-2xl border border-white/15",
          className
        )}
      >
        <div
        ...
        >
          ...
          <div className="absolute inset-0 h-full w-full rounded-xl bg-linear-to-b from-black/20 via-transparent to-black/65" />

          <div className="relative flex flex-col justify-between rounded-xl p-4 text-white col-span-full">
            <div className="flex items-start justify-between">
              ...
              {href && (
                <motion.a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm ring-1 ring-inset ring-white/30 transition-colors hover:bg-white/30 shrink-0"
                >
