...
export function NotFoundPage({
  title = "Looks like you’re on the wrong network",
  message = "Or you may need to reconnect to the network.",
  actionLabel = "Go to Home",
  onAction,
}: NotFoundPageProps) {
  const navigate = useNavigate();
  const handleClick = onAction ?? (() => navigate("/"));
        ...
        <div className="flex justify-center">
          <div className="w-full sm:w-10/12 md:w-8/12 text-center">
            ...
            <div className="mt-[-50px]">
              ...
              <p className="mb-6 text-black sm:mb-5">{message}</p>
